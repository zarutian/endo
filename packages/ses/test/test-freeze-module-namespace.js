...
test('freeze module-namespace-let-2', t => {
  ...
  t.throws(() => freeze(nsLet2), {
    message: /Cannot assign to read only property 'two' of object '\[object Module\]'/,
  });
...
test('freeze module-namespace-const-3-4', t => {
  ...
  t.throws(() => freeze(nsConst34), {
    message: /Cannot assign to read only property 'four' of object '\[object Module\]'/,
  });
  ...
  t.throws(() => freeze(nsConst34), {
    message: /Cannot assign to read only property 'three' of object '\[object Module\]'/,
  });
...
test('freeze module-namespace-live-5-6', t => {
  ...
  t.throws(() => freeze(nsLive56), {
    message: /Cannot assign to read only property 'five' of object '\[object Module\]'/,
  });
  ...
  t.throws(() => freeze(nsLive56), {
    message: /Cannot assign to read only property 'writeFive' of object '\[object Module\]'/,
  });
...
test('freeze module-namespace-live-7-8', t => {
  ...
  t.throws(() => freeze(nsLive78), {
    message: /Cannot assign to read only property 'seven' of object '\[object Module\]'/,
  });
  t.throws(() => freeze(nsLive78), {
    message: /Cannot assign to read only property 'writeSeven' of object '\[object Module\]'/,
  });
