 ...
 * `get`, `set`, `delete`. Note that neither `clear` nor `getSize` are
 * guaranteed to deref. Thus, a call to `map.getSize()` may reflect values that
 * might still be collected later in the same turn.
 *
 * @template K
 * @template {object} V
 *
